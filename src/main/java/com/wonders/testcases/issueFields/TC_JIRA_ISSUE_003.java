...
import com.wonders.service.issue.WikiHelpPageService;
...
public class TC_JIRA_ISSUE_003 {
	...
	private WikiHelpPageService wikiHelpPageService;
	@Parameters({"browser"})
	...
	public void setup(@Optional("Chrome")String browser) {
		...
		wikiHelpPageService = new WikiHelpPageService(home.driver);
	}
	 ...
	 * @author:	bluce
	 * @serialData:	2013-04-30 21:15:22.729
	 * @point:	
	 * @memo:	
	 */
	@Test(description = "验证新建issue的窗口中的帮助功能可以正常显示（wiki markup help）")
	public void JIRA_ISSUE_003(){		
		//login
		...
		home.driver.switchToWindow("Text Formatting Notation Help - Your Company JIRA");

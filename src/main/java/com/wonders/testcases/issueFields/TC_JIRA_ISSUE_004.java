...
import com.wonders.service.issueFields.LocalHelpPageService;
...
public class TC_JIRA_ISSUE_004 {
	...
	@Test(description = "验证新建issue的窗口中的帮助功能可以正常显示（local help）")
	public void JIRA_ISSUE_004(@Optional("admin")String adminUser, @Optional("admin")String adminPW) {
		// login
		...
		BaseHome.driver.switchToWindow("JIRA - Time Tracking - Your Company JIRA");

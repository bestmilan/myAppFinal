...
@Test(groups = {"project", "hard", "search3" })
public class TC_JIRA_ISSUE_007 extends AbstractSpringTest {
	@Autowired
	...
	public Object[][] providerTestData() throws IOException {
		return ReadTestData.readXmlData("searchIssue.xml");
	}
	...
	public void JIRA_ISSUE_007(String blockType, String block, String status, String reporter, String days) {
		// login
